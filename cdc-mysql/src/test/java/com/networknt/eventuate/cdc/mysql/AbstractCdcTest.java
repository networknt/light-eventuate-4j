...
public class AbstractCdcTest {
  ...
  public EntityIdVersionAndEventIds saveEvent(EventuateLocalAggregateStore localAggregateCrud, String eventData) {
  ...
  public EntityIdVersionAndEventIds updateEvent(String entityId, Int128 entityVersion, EventuateLocalAggregateStore localAggregateCrud, String eventData) {
    List<EventTypeAndData> events = Collections.singletonList(new EventTypeAndData(AccountCreatedEvent.class.getTypeName(), eventData, Optional.empty()));
