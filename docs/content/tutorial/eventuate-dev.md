...
java -jar target/cdc-server-1.4.0.jar
``` 
...
```
cd ~/networknt/light-eventuate-4j/cdc-server
java -cp target/cdc-server-1.4.0.jar com.networknt.server.Server
```
...
java -cp ~/networknt/light-eventuate-4j/docker/command/service/*:target/hybrid-command-1.4.0.jar com.networknt.server.Server
```
...
java -cp ~/networknt/light-eventuate-4j/docker/query/service/*:target/hybrid-query-1.4.0.jar com.networknt.server.Server
