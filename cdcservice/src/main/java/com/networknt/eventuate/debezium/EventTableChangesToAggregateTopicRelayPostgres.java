 ...
 */
public class EventTableChangesToAggregateTopicRelayPostgres extends EventTableChangesToAggregateTopicRelay{


    public EventTableChangesToAggregateTopicRelayPostgres(String kafkaBootstrapServers,
    ...
    public CompletableFuture<Object> startCapturingChanges() throws InterruptedException {
        ...
        String connectorName = "postgre_sql-connector";
    ...
    public void handleEvent(SourceRecord sourceRecord) {
        ...
        if ("light-event-sourcing.postgres.events".equals(topic)) {
