...
public class EventuateEmbeddedTestAggregateStoreTest {
  ...
  private AggregateCrud eventStore = SingletonServiceFactory.getBean(AggregateCrud.class);

  private AggregateEvents aggregateEvents = SingletonServiceFactory.getBean(AggregateEvents.class);
